      ...
      <v-flex xs12>
        <v-card hover>
          <v-card-title>
            ...
            <h3 class="
                ml-3
                font-weight-thin">{{getPost.likes}} LIKES</h3>
            <v-spacer></v-spacer>
            <v-icon
              color="info"
              large
          ...
          >
            ...
            <template v-for="message in getPost.messages">
              ...
              <v-list-tile
                ...
                :key="message.title"
              >
                <v-list-tile-avatar><img :src="message.messageUser.avatar"></v-list-tile-avatar>
                <v-list-tile-content>
                  <v-list-tile-title>
                    {{ message.messageBody}}
                  </v-list-tile-title>
...
export default {
  ...
  methods: {
    ...
    checkIfPostLiked(postId) {
      //check if user favorties includes post with id of 'postId'
      if (
        this.userFavorites &&
