<template>
  <v-container class="text-xs-center">
    ...
    >
      <v-flex xs12>
        <h2 class="font-weight-light">Your Posts <span class="font-weight-regular">({{userPosts.length}})</span></h2>
      </v-flex>
      <v-layout
        row
        wrap
    ...
    >
      ...
      <v-container class="headline grey lighten-3">
        <v-form
          v-model="isFormValid"
          ...
          <v-layout row>
            <v-flex xs12>
              <v-select
                ...
                :items="['Art', 'Education', 'Travel', 'Photography','Food', 'Furniture', 'Technology']"
                multiple
                label="Categories"
              ></v-select>
            </v-flex>
